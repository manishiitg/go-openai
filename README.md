# Go OpenAI
[![Go Reference](https://pkg.go.dev/badge/github.com/manishiitg/go-openai.svg)](https://pkg.go.dev/github.com/manishiitg/go-openai)
[![Go Report Card](https://goreportcard.com/badge/github.com/manishiitg/go-openai)](https://goreportcard.com/report/github.com/manishiitg/go-openai)
...
### Installation:
```
go get github.com/manishiitg/go-openai
```
...
import (
	"context"
	"fmt"
	openai "github.com/manishiitg/go-openai"
)
...
See also: https://pkg.go.dev/github.com/manishiitg/go-openai#ClientConfig
</details>
...
import (
	...
	"github.com/manishiitg/go-openai"
)
...
We want to take a moment to express our deepest gratitude to the [contributors](https://github.com/manishiitg/go-openai/graphs/contributors) and sponsors of this project:
